...
app.use('/nhsuk/assets', express.static('./node_modules/nhsuk-frontend/packages/assets'))
app.use('/govuk/assets', express.static('./node_modules/govuk-frontend/dist/govuk/assets'))
app.use('/nhsuk-frontend', express.static('./node_modules/nhsuk-frontend/packages'))
...
app.use('/form-validation.js', express.static('./node_modules/nhsuk-prototype-rig/lib/form-validation.js'))
...
if (useAutoStoreData) {
  ...
  app.use('/auto-store-data.js', express.static('./node_modules/nhsuk-prototype-rig/lib/auto-store-data.js'))
}
