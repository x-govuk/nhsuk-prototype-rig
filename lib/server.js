...
import { findAvailablePort, getEnv, getEnvBoolean } from './environment.js'
...
const useDatabaseSessionStore = getEnvBoolean(
...
app.use('/nhsuk', express.static('./node_modules/nhsuk-frontend/dist/nhsuk'))
...
} else if (useDatabaseSessionStore) {
